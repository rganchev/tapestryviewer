...
export const action = async (event, context) => {
  ...
  const tapestrySheet = doc.sheetsByIndex[0]; // you may want to customize this if you have more than 1 sheet
  const itemsSheet = doc.sheetsByIndex[1]; // you may want to customize this if you have more than 1 sheet
      ...
      case "POST":
        ...
        if (data.tapestry) {
          ...
          return {
            statusCode: 200,
            body: JSON.stringify({
              message: `POST Success - added tapestry row ${
                addedRow._rowNumber - 1
              }`,
        ...
        if (data.item) {
          ...
          return {
            statusCode: 200,
            body: JSON.stringify({
              message: `POST Success - added item row ${
                addedRow._rowNumber - 1
              }`,
              rowNumber: addedRow._rowNumber - 1, // minus the header row
            }),
